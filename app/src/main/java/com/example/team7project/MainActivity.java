...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    //Placeholder data, should use api to pull images
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Array adapter pulling from array. Data is in the strings.xml as string-array
        ...
        //gridview layout. GridAdapter.java is the custom layout
